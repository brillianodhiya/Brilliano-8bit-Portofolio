...
export default function ArcadeTetris() {
  ...
  return (
    ...
    >
      <SEO 
        title="Arcade: Tetris | Secret Dungeon"
        description="Play the classic Tetris game in a retro pixel-art style."
      />
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="pixel-panel px-4 py-2 bg-green-500/10 border-green-500/50">
          <span className="font-display text-[10px] text-green-400">ARCADE MODE: TETRIS</span>
        </div>
      </div>
      ...
      <div className="mt-8 text-center">
        <p className="font-body text-muted-foreground italic text-sm">
          "The pieces will always fall, but how you stack them is up to you."
        </p>
      </div>
    </motion.div>
  );
